...
{
    class CircleAgent : ICircleAgent 
    {
        ...
        protected void DebugSensorsInfo()
        {
            ...
            {
                Console.WriteLine("CIRCLE - Numbers info - {0} - {1}", t, i);
                t++;
            }
            */

            Console.WriteLine("CIRCLE - collectibles left - {0}", nCollectiblesLeft);
            Console.WriteLine("CIRCLE - collectibles info size - {0}", collectiblesInfo.Count());

            /*
            t = 0;
            foreach (long i in rectangleInfo)
            {
                Console.WriteLine("CIRCLE - Rectangle info - {0} - {1}", t, i);
                t++;
            }
            ...
            {
                Console.WriteLine("CIRCLE - Circle info - {0} - {1}", t, i);
                t++;
            }
            ...
            {
                Console.WriteLine("CIRCLE - Obstacles info - {0} - {1}", t, i);
                t++;
            }
            ...
            {
                Console.WriteLine("CIRCLE - Rectangle Platforms info - {0} - {1}", t, i);
                t++;
            }
            ...
            {
                Console.WriteLine("CIRCLE - Circle Platforms info - {0} - {1}", t, i);
                t++;
            }
            */
            t = 0;
            ...
            {
                Console.WriteLine("CIRCLE - Collectibles info - {0} - {1}", t, i);
                t++;
            }
        }
